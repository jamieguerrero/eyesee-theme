...
var _foundationUtil8 = __webpack_require__(10);
...
_foundation.Foundation.plugin(_foundation9.Orbit, 'Orbit');
// Foundation.plugin(ResponsiveMenu, 'ResponsiveMenu');
// Foundation.plugin(ResponsiveToggle, 'ResponsiveToggle');
_foundation.Foundation.plugin(_foundation10.Reveal, 'Reveal');
 ...
 * performed.
 */
(0, _jquery2.default)('[data-equalizer-ignore-class]').each(function (index, element) {
  'use strict';

  var $targetElement = (0, _jquery2.default)(element);
  var equalizerId = $targetElement.data('equalizer-watch');
  var $equalizerContainer = $targetElement.closest('[data-equalizer="' + equalizerId + '"]');
  var equalizerIgnoreClasses = $targetElement.data('equalizer-ignore-class');
  var _addIgnoredClassesDebounced = _.debounce(_addIgnoredClasses, 250);
  var calculationsInProgress = 0;

  $equalizerContainer.on('preequalizedrow.zf.equalizer', function (event) {
    calculationsInProgress++;

    $targetElement.removeClass(equalizerIgnoreClasses);
  });

  $equalizerContainer.on('postequalizedrow.zf.equalizer', function (event) {
    calculationsInProgress--;
 ...
 */
(0, _jquery2.default)('[data-equalizer-singleton-row-height-fix]').each(function (index, element) {
  'use strict';
  ...
  (0, _jquery2.default)(document).on('preequalizedrow.zf.equalizer', function (event) {
    if (!$fixElement) {
      $fixElement = $targetElement.clone();

      var $dataEqualizerIgnoreClassElements = (0, _jquery2.default)('[data-equalizer-ignore-class]');

      $dataEqualizerIgnoreClassElements.each(function (index, element) {
        var $ignoreClassElement = (0, _jquery2.default)(element);
        var equalizerIgnoreClasses = $ignoreClassElement.data('equalizer-ignore-class');
  ...
  (0, _jquery2.default)(document).on('postequalizedrow.zf.equalizer', function (event) {
...
(0, _jquery2.default)('[data-mirror]').each(function (index, element) {
  'use strict';

  var $dataMirrorContainer = (0, _jquery2.default)(element);
  var dataMirrorId = $dataMirrorContainer.data('mirror');
  var $dataMirrorWatchers = $dataMirrorContainer.find('[data-mirror-watcher="' + dataMirrorId + '"]');
  var mirrorStartedOn = $dataMirrorContainer.data('mirror-state') === 'on';
  var $mirrorToggler = (0, _jquery2.default)('[data-mirror-toggler="' + dataMirrorId + '"]');

  $mirrorToggler.change(function (event) {
    var newMirrorState = $mirrorToggler.is(':checked') ? 'on' : 'off';

    $dataMirrorContainer.data('mirror-state', newMirrorState);
  });

  $dataMirrorWatchers.each(function (index, element) {
    var $watcher = (0, _jquery2.default)(element);
    var mirrorSourceSelector = '#' + $watcher.data('mirror-source');
    var $mirrorSource = (0, _jquery2.default)(mirrorSourceSelector);
    ...
    $mirrorSource.on('change', function (event) {
      var mirrorOn = $dataMirrorContainer.data('mirror-state') === 'on';
...
(0, _jquery2.default)(document).ajaxSuccess(function (event, xhr, opts, data) {
  'use strict';

  var isRevisit = opts.data === 'nextStep=shipping_method';

  if (!data || !data['checkout-steps'] || isRevisit) {
    return;
  }

  var $shippingMethodForm = (0, _jquery2.default)('.checkout-shipping-option-form');
  var $shippingMethodAutoSubmitRadioButtons = $shippingMethodForm.find('[data-shipping-method-auto-submit]');
...
(0, _jquery2.default)(document).on('change', '[data-sort-redirect]', function (event) {
  'use strict';

  var $sortElement = (0, _jquery2.default)(event.currentTarget);
  var sortParams = $sortElement.val().split('&');
  var baseUrl = window.location.protocol + '//' + window.location.host;
  var path = window.location.pathname;
  var searchParams = _.reduce(sortParams, function (searchParams, sortParam, index) {
...
(0, _jquery2.default)(document).on('change', '.product-form [name^="options"], .product-form [name^="extras"]', function (event) {
  'use strict';

  var $triggerElement = (0, _jquery2.default)(event.currentTarget);
  var $productContainer = $triggerElement.closest('.product');
...
(0, _jquery2.default)(document).on('change', 'input[name="shippingMethod"]', function (event) {
  'use strict';

  var $shippingInput = (0, _jquery2.default)(event.currentTarget);
  var $shippingOptionForm = $shippingInput.closest('.checkout-shipping-option-form');
  var $formSubmitButton = $shippingOptionForm.find('[type="submit"]');
